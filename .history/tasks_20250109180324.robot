...
Fill and submit the form for one person 
  [Arguments]    ${orders}
  Select From List By Value    //*[@id="head"]   
#   Is Radio Button Set To  //*[@id="address"]      ${orders}[Sales Target]
  Is Radio Button Selected    group_name
  Input Text     //*[@id="1736424460430"]     
  Input Text    //*[@id="address"]    ${orders}[First Name]
