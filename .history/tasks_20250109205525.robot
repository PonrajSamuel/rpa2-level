...
Fill and submit the form for one person 
  [Arguments]    ${orders}
  Select From List By Value    //*[@id="firstname"]    ${orders}[First Name]
  Click Element    //*[@id="lastname"]    ${orders}[First Name]
  Click Element   //*[@id="salesresult"]   ${orders}[Sales]
  Input Text     //*[@id="salestarget"]      ${orders}[Sales Target]
  Input Text    //*[@id="sales-form"]/button
  Scroll Element Into View    //*[@id="order"]
  Click Button   //*[@id="order"] 
  Sleep    5s
  Click Button    //*[@id="order-another"]
Fill the form using the data from the Excel file
  ...
  FOR    ${orders}    IN    @{orders}
        Open the robot order website ${orders}
  END  
# Fill and submit the form
