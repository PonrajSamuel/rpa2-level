...
Fill and submit the form for one person 
  [Arguments]    ${orders}
  Select From List By Value    //*[@id="firstname"]    ${orders}[head]
  Click Element    //*[@id="lastname"]    ${orders}[body]
  Click Element   //*[@id="salesresult"]   ${orders}[legs]
  Input Text     //*[@id="salestarget"]      ${orders}[legs]
  Input Text    //*[@id="sales-form"]/button ${orders}[address]
  Scroll Element Into View    //*[@id="order"]
  Click Button   //*[@id="order"] 
  Sleep    5s
  Click Button    //*[@id="order-another"]
